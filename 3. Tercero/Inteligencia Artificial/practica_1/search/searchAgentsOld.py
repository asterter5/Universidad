...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        #self.corners = ((right, 1), (right, top),(1,top) ,(1,1) )
        ...
        self.startState=(self.startingPosition,self.corner_visited)
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
			...
			nextx, nexty = int(x + dx), int(y + dy)
			hitsWall = self.walls[nextx][nexty]
			next_corners_visited=corners_visited[:]#Copia
			if not hitsWall:
				in_corner=0#contado para las esquinas
				for corner in self.corners:
					if((nextx,nexty)==corner):
						break
					in_corner+=1
				if(in_corner<4): #Si he llegado a las 3 esquinas
					next_corners_visited[in_corner]=True #Ponemos el 4 a True
...
def cornersHeuristic(state, problem):
    ...
    for i in range(4):
        #print "paso ",i,next_position,next_corners_visited
        ...
        for corner in next_corners_visited:
            ...
            num_corner+=1
        #print "distancia ",dist_to_corners
        num_closest=0
        num_corner=0
    ...
    #print "Heuristica:",result
    
    return result
    #return 0 # solucion por defecto
...
def foodHeuristic(state, problem):
	...
	#NO se si es una buena solucion, pasa el Autograder, 
	#pero el medium search es incapaz de resolverlo
	#La heuristica:
	#distacia manhattan cercano+distancia manhattan lejano
