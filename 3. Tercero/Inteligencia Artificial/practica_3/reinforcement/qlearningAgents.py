...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        possible_states_qValues = util.Counter()
        for action in self.getLegalActions(state):
        	possible_states_qValues[action] = self.getQValue(state, action)

        return possible_states_qValues[possible_states_qValues.argMax()]
        #util.raiseNotDefined()
    ...
    def computeActionFromQValues(self, state):
        ...
        if possible_states_qValues.totalCount() == 0:
        	return random.choice(possible_actions)
        else:
        	return possible_states_qValues.argMax()
        #util.raiseNotDefined()
