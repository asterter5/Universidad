...
public class CtrlReproductor implements Serializable {
     ...
     */
    public void resumeFitxer(FitxerAudio fa) {
        ra.resumeAudioFile(fa);
    }
     ...
     * @param fa (FitxerAudio)
     */
    public void pauseFitxer(FitxerAudio fa) {
        ra.pauseAudioFile(fa);
    }
     ...
     * @param fa (FitxerAudio)
     */
    public void stopFitxer(FitxerAudio fa) {
        ra.stopAudioFile(fa);
    }
