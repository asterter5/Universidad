...
public class FitxerAudio extends File implements Serializable {
    ...
    public String toString() {
        String sng = "| Titol: "+ this.songname +" | Autor: "+ this.autor +" | Disc: "+ this.disc +" | Pista: "+ this.numsong +" | Dicografica: "+ this.discog +" | Duracio: "+ this.songlen +" | Any: "+ this.any +" | Fitxer: <"+ this.getAbsolutePath() +"> |";
        return sng;
    }
}
